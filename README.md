# 📦 Office Stock — ระบบจัดการสต็อก งานซ่อม และงานบำรุงรักษา IT

ระบบ Web Application สำหรับงาน IT สำนักงาน แบ่งเป็น **3 โมดูล** ที่ใช้ผู้ใช้งาน/แผนก/ช่าง/ระบบล็อกอินร่วมกัน:
...
| Export | ExcelJS (.xlsx) + PDFKit (.pdf) — generic column-driven builder ใช้ร่วมกันทั้ง 3 โมดูล (นิยามคอลัมน์อยู่ที่ `reportColumns.ts`) |
...
> role มีผลเฉพาะกับเมนู **ผู้ใช้งาน** เท่านั้น — ผู้ใช้ที่ล็อกอินแล้วทุก role เข้าถึงได้ครบทั้ง 3 โมดูล (รวมถึงเปิด/แก้ไข/ลบใบงานซ่อม, อุปกรณ์บำรุงรักษา, ประวัติ และ master list ทั้งหมด)
...
│   │   ├── dashboard/             # ภาพรวมสต็อก + ตารางสต็อก + การ์ดงานซ่อมค้าง/เกินกำหนด + การ์ด PM เกินกำหนด
...
- ✅ **Dashboard** — สรุปจำนวนสต็อก, สินค้าใกล้หมด, รายการวันนี้ + การ์ดงานซ่อมค้าง/เกินกำหนด และการ์ดอุปกรณ์ที่เลยรอบบำรุงรักษา (คลิกไปยังโมดูลนั้นได้)
...
- ✅ **สลับโมดูลจาก Header** — แท็บ สต็อก/งานซ่อม/บำรุงรักษา ด้านบน, Sidebar เปลี่ยนเมนูตามโมดูลอัตโนมัติ (เมนู active เลือกจาก longest-prefix match — `/repairs/7/edit` จึงยังไฮไลต์ "รายการงานซ่อม")
...
- ✅ **หลายภาษา (TH/EN)** — สลับภาษาได้จาก Sidebar ทุกหน้า จำค่าไว้ด้วย cookie ครอบคลุมทั้ง 3 โมดูล
