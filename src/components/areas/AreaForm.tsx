...
import { createAreaAction, type AreaActionState } from "@/actions/area.actions";

const initState: AreaActionState = { success: false, message: "" };

export default function AreaForm() {
  const t = useTranslations("AreaForm");
  const tc = useTranslations("Common");
  const [state, formAction, pending] = useActionState(createAreaAction, initState);
