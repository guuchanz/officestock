...
import { createDeviceTypeAction, type DeviceTypeActionState } from "@/actions/deviceType.actions";

const initState: DeviceTypeActionState = { success: false, message: "" };

export default function DeviceTypeForm() {
  const t = useTranslations("DeviceTypeForm");
  const tc = useTranslations("Common");
  const [state, formAction, pending] = useActionState(createDeviceTypeAction, initState);
