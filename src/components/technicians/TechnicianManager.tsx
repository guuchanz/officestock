...
/**
 * The technician list is shared by the Repair and Maintenance modules.
 *
 * It is mounted at two routes rather than linked across modules because
 * `moduleForPath()` resolves a path to exactly one module — a single shared
 * URL in both sidebars would flip the header tab to the other module when
 * clicked. Same data, same component, one route per module.
 */
export default async function TechnicianManager() {
